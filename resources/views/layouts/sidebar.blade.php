...
<div id="sidebar"
    ...
    <div class="flex-1 overflow-y-auto p-4 space-y-6">
        ...
        <!-- REQUEST MANAGEMENT -->
        @php
            $requestsActive = request()->routeIs('requests.index');
        @endphp
        ...
        @php
            $myRequestsActive = request()->routeIs('requests.my');
        @endphp
        ...
        <a
            ...
            class="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition"
        >
            {{-- icon --}}
        ...
        <!-- MASTER DATA -->
        <div>
            <h3 class="text-xs uppercase text-slate-400 font-semibold mb-2 px-3">
                Master Data
            </h3>
            ...
            <ul class="space-y-1">
                ...
                {{-- Users --}}
                <li>
                    <a class="flex items-center gap-3 px-3 py-2 rounded-md font-medium text-sm transition-colors {{ $usersActive ? 'bg-indigo-50 text-indigo-600' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50' }}"
                ...
                {{-- Categories --}}
                <li>
                    <a class="flex items-center gap-3 px-3 py-2 rounded-md font-medium text-sm transition-colors {{ $categoriesActive ? 'bg-indigo-50 text-indigo-600' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50' }}"
        ...
        <div>
            ...
            <ul class="space-y-1">
                <li>
                            <a
                                href="#"
                                class="block py-2 px-4 text-slate-600 hover:text-indigo-600 hover:bg-slate-50 transition-colors"
                            >
                                Settings
                            </a>
                        </li>
                ...
                <form action="{{ route('logout') }}" method="POST">
                    ...
                    <button type="submit"
                            class="w-full flex items-center gap-3 px-3 py-2 rounded-md text-slate-600 hover:text-red-600 hover:bg-red-50 font-medium text-sm transition-colors">
